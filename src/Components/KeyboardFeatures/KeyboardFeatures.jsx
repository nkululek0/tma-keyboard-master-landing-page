...
export function KeyboardFeatures () {
    ...
    return (
        <div className='keyboard-feature-wrapper w-full'>
            <section className="grid grid-cols-1 gap-12 mx-4 min-[768px]:grid-cols-2 min-[1024px]:grid-cols-4 min-[1024px]:w-[80%] min-[1024px]:mx-auto">
                <Feature
                    image={ Screen }
