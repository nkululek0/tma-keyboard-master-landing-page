...
export function Hero () {
    ...
    return (
        <article className='hero-wrapper mb-8'>
            <section className='hero-content mx-4'>
                <div className='description-wrapper mb-8'>
                    <h1 className='main-heading text-5xl font-[900] uppercase mb-4'>Typemaster Keyboard</h1>
                ...
                <div className='flex justify-between items-center mb-12'>
                    ...
                    <p className='text-2 font-[600] uppercase'>Release on 5/27</p>
                </div>
            </section>
            <div className='hero-image'>
                <img src={ Keyboard } alt='image of black keyboard' />
            </div>
        </article>
    )
}