...
export function Hero () {
    ...
    return (
        <div className='hero-wrapper min-[1024px]:flex min-[1024px]:gap-4'>
            <div className="spacer hidden flex-grow-[1] min-[1024px]:block"></div>
            <article className='mb-4 min-[768px]:flex min-[768px]:items-center min-[1024px]:w-[80vw] min-[1024px]:h-[22rem] min-[1024px]:gap-30'>
                <section className='hero-content mx-4 min-[768px]:h-[17rem] min-[1024px]:m-0'>
                ...
                <div className='hero-image relative w-full h-[17rem] ml-4 overflow-clip rounded-tl-2xl rounded-bl-2xl min-[768px]:h-[22rem] min-[1024px]:m-0 min-[1024px]:rounded-2xl'>
            ...
            <div className="hero-decorator hidden h-[11rem] flex-grow-[1] rounded-2xl min-[1024px]:block"></div>
        </div>
    )
}