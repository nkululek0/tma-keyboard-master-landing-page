...
export function AdditionalContent () {
    ...
    return (
        <div className="additional-content-wrapper min-[1024px]:flex min-[1024px]:gap-4 min-[1024px]:mb-12">
            <div className="additional-decorator hidden h-[11rem] flex-grow-[1] self-end rounded-2xl min-[1024px]:block"></div>
            <article className='mb-12 min-[768px]:ml-4 min-[1024px]:flex min-[1024px]:gap-24 min-[1024px]:w-[80vw] min-[1024px]:m-0'>
