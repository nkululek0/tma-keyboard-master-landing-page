...
export function AdditionalContent () {
    ...
    return (
        <article className='additional-content-wrapper mb-12'>
            <div className='additional-content-image flex gap-4 mb-12'>
                ...
                <div className="second-image-wrapper w-6/10 overflow-clip relative rounded-2xl">
            ...
            <section className='additional-content mx-4'>
                <h2 className='main-heading w-min font-[900] uppercase mb-4'>Mechanical wireless keyboard</h2>
